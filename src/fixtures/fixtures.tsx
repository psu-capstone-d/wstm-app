        ...
        activities: [
            {
                ...
                answers: [
                    ...
                    {text: "Make an account using all your friend’s information to be more secure.", isCorrect: false},
                ]
            },
            {
                type: "question",
                ...
                answers: [
                    ...
                    {text: "Never, you should never share login information", isCorrect: true},
            ...
            },
            {
                ...
                answers: [
                    ...
                    {text: "Choose 'Password' so I don't have to remember it", isCorrect: false},
                    {text: "Create a password using personal information only my friends know", isCorrect: false},
                ]
            },
            {
                type: "question",
                ...
                answers: [
                    ...
                    {text: "Never logout of online accounts so you don't have to log back in", isCorrect: false},
                    {
                        text: "Store a file with all your passwords in it so you can copy and paste them when needed",
                        isCorrect: false
                    },
                    {text: "There's no other way to log in unless you have an alphanumeric password", isCorrect: false},
                ]
            },
            {
                type: "question",
            ...
            },
            {
                ...
                choice: "single",
                answers: [
                    {text: "Put all your private information on your profile", isCorrect: false},
                    {text: "Post pictures of your house and post them on your profile", isCorrect: false},
                    {text: "Make public posts about where you are and what you are doing", isCorrect: false},
                    {
            ...
            },
            {
                ...
                answers: [
                    ...
                    {text: "When I find a cool app I downloaded from a website", isCorrect: false},
                ]
            }
        ]
        ,
